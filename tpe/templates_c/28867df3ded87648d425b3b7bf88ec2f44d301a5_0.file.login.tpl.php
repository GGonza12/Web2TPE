<?php
/* Smarty version 3.1.39, created on 2021-10-12 04:13:06
  from 'C:\xampp\htdocs\Web2TPE\tpe\templates\login.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_6164ef3288fa65_01491603',
...
function content_6164ef3288fa65_01491603 (Smarty_Internal_Template $_smarty_tpl) {
...
<form action="createacount" method="POST">
    <input placeholder="usuario" type="text" name="user" required>
    <input placeholder="email" type="email" name="email" required>
    <input placeholder="Contraseña" type="password" name="password" required>
    <input type="submit">
</form><?php }
