...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-10-2021 a las 01:23:40
...
CREATE TABLE `juegos` (
  ...
  `id _empresa` tinyint(4) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
ALTER TABLE `juegos`
  ...
  ADD KEY `id _empresa` (`id _empresa`);
...
--
ALTER TABLE `juegos`
  MODIFY `id_juego` tinyint(4) NOT NULL AUTO_INCREMENT;
